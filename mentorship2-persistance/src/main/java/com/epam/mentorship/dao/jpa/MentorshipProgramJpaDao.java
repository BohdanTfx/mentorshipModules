...
public class MentorshipProgramJpaDao extends
        GenericJpaDao<MentorshipProgram, Long> implements MentorshipProgramDao {
    private static final long serialVersionUID = -7409711151154967958L;

    public MentorshipProgramJpaDao() {
        super(MentorshipProgram.class);
    }
}
